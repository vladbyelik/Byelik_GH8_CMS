 ...
 */
?>
<header class="header header-page" role="header">
  <div class="container">
...
<div id="main-wrapper">
  <div id="main" class="main">
    ...
    <div id="content" class="container content-page">
...
<footer id="footer" class="footer" role="footer">
  <div class="container">
    ...
    <div>
        ...
        <?php endif; ?>
        <small class="pull-right">Developed by Geekhub geekhub.ck.ua<a href="#"><?php print t('^'); ?></a></small>
    </div>
  </div>
</footer>
